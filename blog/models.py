...
class Post(models.Model):
    ...
    created = models.DateTimeField(auto_now_add=True) # date will be saved automatically when creating an object.
    updated =  models.DateTimeField(auto_now=True) # updated automatically when saving an object.
    ''' enumeration class Status by subclassing models.TextChoices '''
    ...
    ''' This is the default Python method to return a string 
    with the human-readable representation of the object. 
    Django will use this method to display the name of the object in many places, 
    such as the Django administration site. '''
